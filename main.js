...
className: 'white-marker'  
  ...
  var cities = [
      ...
      {name: "London", coords: [51.5074, -0.1278], comment: "Expanded my horizons in a global city. Studied in a prestigious highschool, focusing in computer science, design, and"},
      {name: "Lisbon", coords: [38.7223, -9.1393], comment: "Embraced new cultures and perspectives. I focused on sustainable development and cultural exchange."},
      {name: "Cologne", coords: [50.9375, 6.9603], comment: "Deepened my European experience. I specialized in data-driven decision making and AI applications."},
